...
class PoseEngine(BasicEngine):
    ...
    def DetectPosesInImage(self, img):
        ...
        return inference_time, self._parse_poses(outputs), self._parse_heatmap(outputs)
    ...
    def ParseOutputs(self, outputs):
        ...
        return self._parse_poses(outputs), self._parse_heatmap(outputs)
    ...
    def _parse_heatmap(self, outputs):
        if len(outputs) >= 5:
          return outputs[4]
        else:
          return None
